...
BEGIN {
	use lib '../../';
	use_ok('GAL::Parser::cuffdiff_gene_exp');
}
...
my $parser = GAL::Parser::cuffdiff_gene_exp->new(file => 'data/cuffdiff_gene_exp.diff');

isa_ok($parser, 'GAL::Parser::cuffdiff_gene_exp');
